...
<head>
    ...
    <title>Add Product - TechVerse Admin</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Fill in the details to add a new product</p>
        </div>
            ...
            <form action="{{ route('admin.inventory.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600">{{ old('description') }}</textarea>
                </div>
